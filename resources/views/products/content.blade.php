                ...
                <div class="col-md-6 col-lg-5 p-b-30">
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        ...
                        <span class="mtext-106 cl2">
                            {!! Helpers::getPrice($product->price, $product->price_sale) !!}
                        </span>
                                    ...
                                    <div class="rs1-select2 bor8 bg0">
                                        <select class="js-select2 select2-hidden-accessible" name="time" tabindex="-1"
                                            ...
                                            dir="ltr" style="width: 142px;"><span class="selection"><span
                                                    ...
                                                    aria-labelledby="select2-time-5r-container"><span
                                                        class="select2-selection__rendered" id="select2-time-5r-container"
                                    ...
                                    <div class="rs1-select2 bor8 bg0">
                                        <select class="js-select2 select2-hidden-accessible" name="time" tabindex="-1"
                                            ...
                                            dir="ltr" style="width: 142px;"><span class="selection"><span
                                                    class="select2-selection select2-selection--single" role="combobox"
                                                    aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                    aria-labelledby="select2-time-pb-container"><span
                                                        class="select2-selection__rendered" id="select2-time-pb-container"
                                                        title="Choose an option">Choose an option</span><span
                                                        class="select2-selection__arrow" role="presentation"><b
                                                            role="presentation"></b></span></span></span><span
                                                class="dropdown-wrapper" aria-hidden="true"></span></span>
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item p-b-10">
                            <a class="nav-link active" data-toggle="tab" href="#reviews" role="tab"
                                aria-expanded="true">Reviews (1)</a>
                        </li> --}}
                    </ul>
